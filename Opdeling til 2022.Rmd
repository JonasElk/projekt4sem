...
#data = data[-c(11:12,24),]
#data = data[-c(11,16),]
```

```{r}
C_l = ts(log(data$c), start = 1999, frequency = 1)
I_l = ts(log(data$Ipr_faste), start = 1999, frequency = 1)
ps = ts(data$ps/100, start = 1999, frequency = 1)
W_l = ts(log(data$W), start = 1999, frequency = 1)
R_l = ts(log(data$R), start = 1999, frequency = 1)
ulc_l = ts(log(data$ulc), start = 1999, frequency = 1)
Pm_l = ts(log(data$Pm), start = 1999, frequency = 1)
Px_l = ts(log(data$Px), start = 1999, frequency = 1)
X_l = ts(log(data$X), start = 1999, frequency = 1)
Yrw_l = ts(log(data$Yrw_dk), start = 1999, frequency = 1)
M_l = ts(log(data$M), start = 1999, frequency = 1)
rulc_l = ts(log(data$rulc), start = 1999, frequency = 1)
E_l = ts(log(data$E), start = 1999, frequency = 1)
P_l = ts(log(data$P), start = 1999, frequency = 1)
Y_l = ts(log(data$Y), start = 1999, frequency = 1)
Yf_l = ts(log(data$Yff), start = 1999, frequency = 1)
r = ts(data$r, start = 1999, frequency = 1)
